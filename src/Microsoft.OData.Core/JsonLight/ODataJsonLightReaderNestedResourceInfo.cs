...
namespace Microsoft.OData.JsonLight
{
    ...
    internal sealed class ODataJsonLightReaderNestedResourceInfo : ODataJsonLightReaderNestedInfo
    {
            ...
            : base(nestedProperty)
        {
            ...
            NestedResourceTypeReference = (nestedProperty != null) ? nestedProperty.Type.ToStructuredType().ToTypeReference(nestedProperty.Type.IsNullable) : null;
            ...
            : base(nestedProperty)
        {
            ...
            {
                nestedType = nestedProperty.Type.ToStructuredType();
            }

            NestedResourceTypeReference = nestedType.ToTypeReference(resourceTypeNullable).AsStructured();
            this.hasValue = isExpanded;
        }
        ...
        internal IEdmType NestedResourceType
        {
            get
            {
               if (NestedResourceTypeReference != null)
                {
                    return NestedResourceTypeReference.Definition;
                }
